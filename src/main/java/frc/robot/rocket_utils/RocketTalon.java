...
public class RocketTalon implements SpeedController {
     ...
     * pretty much just a regular TalonSRX, except
     * has a few extras to make better The main thing it has are the null checks at
     * every turn so we don't have to clutter our main code with them and so we
     * don't get yelled at a lot by the DS when a CAN cable gets unplugged
     */
    ...
    /**
     * Gets whether the motor has been set to be inverted or not True means it has
     * been
     * 
